...
function OwnerSalesReport() {
    ...
    const filteredSales = sales
        .filter((sale) => {
            const matchesSearch = sale.orderId
                .toLowerCase()
                .includes(search.toLowerCase());

            const matchesBranch =
                branch === "all" ||
                sale.branches?.includes(branch);
        ...
        .filter((sale) => {
            ...
            if (filter === "online") {
                return sale.orderType === "Online";
            }

            if (filter === "walk-in") {
                return sale.orderType === "Walk-In";
            }

            if (filter === "gcash") {
                return sale.paymentMethod === "GCash";
            }
        ...
        .sort((a, b) => {
            ...
            if (sort === "units") {
                return Number(b.unitsSold) - Number(a.unitsSold);
            }
                ...
                <div className="content-frame">
                    ...
                    <div className="sales-report-controls">
                        ...
                        <div className="sales-report-actions">
                            ...
                            <button className="sales-report-export">
                                Export
                            </button>
