...
const MOCK_ONLINE_REQUESTS = [
  ...
  },
  {
    ...
    items: [
      { id: "i1", name: "Cappuccino", price: 100, quantity: 1 },
      { id: "i2", name: "Butter Croissant", price: 300, quantity: 1 },
      { id: "i3", name: "Kopi Susu Gula Aren", price: 120, quantity: 2 },
      { id: "i4", name: "Iced Americano", price: 90, quantity: 1 },
      { id: "i5", name: "Ham & Cheese Croissant", price: 250, quantity: 1 },
      { id: "i6", name: "Matcha Latte", price: 150, quantity: 1 },
      { id: "i7", name: "Blueberry Muffin", price: 130, quantity: 3 },
    ],
    total: 1520,
    storeBranch: "Kopi Express – Pandi Main",
    storeAddress: "Siling Bata, Pandi, Bulacan",
